...
class SchoolTeacherScreen(Screen):
        ...
        def on_touch_down(instance, touch):
            if instance.collide_point(*touch.pos):
                if screen_name == 'school_admin_about':
                    ...
                    screen.update_fields(schoolName, type_of_global, role_global, username_global)
...
class MyApp(App):
    def build(self):
        ...
        sm.add_widget(SchoolTeacherScreen(name='school_teacher'))
